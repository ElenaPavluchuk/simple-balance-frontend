...
export const RECENT_CARDS_DATA = [
  {
    ...
    DESCRIPTION: "Your 5 most recent income and expense entries",
    NAVIGATE_TO: null,
    ORDER: "order-5",
    SPANNING_COLUMNS: "col-span-2",
  },
  {
    ...
    TITLE: "Expense",
    DESCRIPTION: "View your expense transactions from the last 30 days",
    NAVIGATE_TO: "/expense",
    ORDER: "order-6",
    SPANNING_COLUMNS: "col-span-2",
  },
  {
    ...
    TITLE: "Income",
    DESCRIPTION: "View your income transactions from the last 30 days",
    NAVIGATE_TO: "/income",
    ORDER: "order-8",
    SPANNING_COLUMNS: "col-span-2",
  },
